...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  else if(hadc->Instance==ADC4)
  {
    ...
    PB12     ------> ADC4_IN3
    */
    HAL_GPIO_DeInit(SENS_BAT_GPIO_Port, SENS_BAT_Pin);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PA7     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(SENSOR_2_GPIO_Port, SENSOR_2_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = FL_MISO_Pin|FL_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(FL_SCK_GPIO_Port, FL_SCK_Pin);

    HAL_GPIO_DeInit(GPIOB, FL_MISO_Pin|FL_MOSI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM5)
  {
    ...
    PA0     ------> TIM5_CH1
    */
    GPIO_InitStruct.Pin = VIB_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(VIB_PWM_GPIO_Port, &GPIO_InitStruct);
